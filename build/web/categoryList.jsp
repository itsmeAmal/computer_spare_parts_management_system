    ...
    <body>
        <div style="position: absolute; left: 20%; top: 180px; width: 973px; height: 490px;background-color: #ccccff;">   
            ...
            <div style="overflow-x:auto;">
                <%
                    ResultSet rset = categoryControl.getAllCategory();
                %>
                <table>
                    <th>Category Name</th>
                    <th>Category Code</th>
                    <th>Category Status</th>
                        ...
                        while (rset.next()) {%>
                    <tr>
                        <td><%= rset.getString("category_name")%></td>
                        <td><%= rset.getString("category_code")%></td>
                        <td><%= rset.getInt("category_status")%></td>

                    <form action="dashBoardServlet">                       
                        <td><button class="button_" style="vertical-align:middle"><span>DELETE </span></button></td>
                        <td><input type="hidden" name="delete" value="<%= rset.getString("category_id")%>"/></td>
                    </form>
                    </tr>                    
                </table>
            </div>
